...
- [60道常见的Kubernetes面试题总结](#60道常见的kubernetes面试题总结)
    - [简述etcd及其特点](#简述etcd及其特点)
    - [简述etcd适应的场景](#简述etcd适应的场景)
    ...
    - [简述Kubernetes Pod的LivenessProbe探针的常见方式](#简述kubernetes-pod的livenessprobe探针的常见方式)
    ...
    - [简述Kubernetes集群联邦](#简述kubernetes集群联邦)
    - [简述Helm及其优势](#简述helm及其优势)



# 60道常见的Kubernetes面试题总结
