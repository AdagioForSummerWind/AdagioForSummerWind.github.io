...
举例：电话安装业务系统：
- 结构化分析-数据流和加工
    - ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211221215208.png)
- 面向对象方法—对象及其关系
    - ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211221215308.png)
...
**软件设计在SE中所处的位置**：
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228091547.png)
...
与之相邻的其他过滤器的工作。
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228095013.png)
- 把系统任务分成若干连续的处理步骤，这些步骤由通过系统的数据流连接，一个步骤
的输出是下一个步骤的输入。
- 每个过滤器独立于其上游和下游的构件而工作，过滤器的设计要针对某种形式的数据
输入，并且产生某种特定形式的数据输出（到下一个过滤器）。过滤器没有必要了解
与之相邻的其他过滤器的工作。
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228095043.png)
...
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228095240.png)
...
- 浏览器-服务器（B/S）
    - 浏览器/服务器(Browser/Server)是四层C/S风格的一种实现方式 。
        ...
        - 逻辑层：
            ...
            - 应用服务器
        - 数据层：数据库服务器
    - 示例：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228100738.png)
...
DFD的主要元素：
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228102944.png)
...
**简单练习**：
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228103410.png)
...
- 加工编号：0
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228103722.png)

0层DFD:
- 将顶层DFD图中的系统分解为若干个子系统，决定每个子系统间的数据接口和活动关系，得到0层DFD图；
- 加工编号：1、2、…、n
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228103809.png)
...
- 编号：
    ...
    - …
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228104011.png)

数据流的分解：
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228104046.png)
...
**错误示例**：
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228104243.png)
## 行为建模与设计
...
- 所有的对象都有“状态”
    ...
    - 每一种状态表示一种可能的状态赋值
- 例如：栈
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228104610.png)

**状态空间**：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211229204632.png)

模型建立的过程——状态空间的分解
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228104718.png)
...
- 组合状态：可以通过状态嵌套的方式简化图表
    ...
    - ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228105249.png)
- 历史状态
...
- 对象（Object）：类的实例，以某种角色参与交互，可以是人，物，其他系统或者子系统
    ...
    - ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228111552.png)
    - 对象的创建与撤销
...
- 一个复杂的顺序图可以划分为几个小块，每一个小块称为一个复合片段。每个复合片段由一个大方框包围，其名称显示在方框左上角的间隔区内，表示该顺序图的信息。
    ...
    - par:并行，每一片段都并发执行
    - loop:循环，片段可多次执行
- 例子：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228113410.png)
...
**例子：银行系统的交易验证：**
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228113452.png)
...
- 例子：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228113655.png)
...
对比例子：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228113759.png)
...
- 泳道：
    ...
    - ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228114310.png)

**例子：“记录学生分数”的活动图：**
- ![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228114056.png)
- 注:活动图与状态图的标记符非常相似，有时会让人混淆。其实, 
- 活动图是用来建模不同区域的工作如何彼此交互的；而状态图用
来表示单个的对象，以及对象的行为如何改变其状态。

例子：![](https://raw.githubusercontent.com/JF-011101/Image_hosting_rep/main/20211228114155.png)
