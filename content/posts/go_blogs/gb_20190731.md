---
title: "Gb_20190731"
date: 2022-10-29T19:42:43+08:00
lastmod: 2022-10-29
...
Note added January 2022: This blog post was written in 2019 and does not describe the version of generics that was finally adopted. For updated information please see [the language spec](https://go.dev/ref/spec) and \[the generics design document\] ([https://go.dev/design/43651-type-parameters)](https://go.dev/design/43651-type-parameters)).
...
The element type of the slice has been factored out. It’s now named `Element` and has become what we call a _type parameter_. Instead of being part of the type of the slice parameter, it’s now a separate, additional, type parameter.
