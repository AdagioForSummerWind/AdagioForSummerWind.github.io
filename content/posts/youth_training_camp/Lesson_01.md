...
- [01简介](#01简介)
	- [1.1什么是Go语言](#11什么是go语言)
	- [1.2哪些公司用Go语言](#12哪些公司用go语言)
	- [1.3字节跳动为什么全面拥抱GO语言](#13字节跳动为什么全面拥抱go语言)
- [02入门](#02入门)
	- [2.1开发环境-安装Golang](#21开发环境-安装golang)
	- [2.1开发环境-配置集成开发环境](#21开发环境-配置集成开发环境)
	- [2.2基础语法-Hello World](#22基础语法-hello-world)
	- [2.2基础语法-变量](#22基础语法-变量)
	- [2.3基础语法-if else](#23基础语法-if-else)
	- [2.4基础语法-循环](#24基础语法-循环)
	- [2.5基础语法-switch](#25基础语法-switch)
	- [2.6基础语法-数组](#26基础语法-数组)
	- [2.7基础语法-切片](#27基础语法-切片)
	- [2.8基础语法-map](#28基础语法-map)
	- [2.9基础语法-range](#29基础语法-range)
	- [2.10基础语法-函数](#210基础语法-函数)
	- [2.11基础语法-指针](#211基础语法-指针)
	- [2.12基础语法-结构体](#212基础语法-结构体)
	- [2.13基础语法-结构体方法](#213基础语法-结构体方法)
	- [2.14基础语法-错误处理](#214基础语法-错误处理)
	- [2.15基础语法-字符串操作](#215基础语法-字符串操作)
	- [2.16基础语法-字符串格式化](#216基础语法-字符串格式化)
	- [2.17基础语法-JSON处理](#217基础语法-json处理)
	- [2.18基础语法-时间处理](#218基础语法-时间处理)
	- [2.19基础语法-数字解析](#219基础语法-数字解析)
	- [2.20基础语法-进程信息](#220基础语法-进程信息)
- [03 实战](#03-实战)
	- [3.1猜谜游戏介绍](#31猜谜游戏介绍)
	- [3.1.1猜谜游戏-生成随机数](#311猜谜游戏-生成随机数)
	- [3.1.2猜谜游戏-生成随机数效果](#312猜谜游戏-生成随机数效果)
	- [3.1.2猜谜游戏-生成随机数V2](#312猜谜游戏-生成随机数v2)
	- [3.1.3猜谜游戏-读取用户输入](#313猜谜游戏-读取用户输入)
	- [1.4猜谜游戏-实现判断逻辑](#14猜谜游戏-实现判断逻辑)
	- [3.1.5猜谜游戏-实现游戏循环](#315猜谜游戏-实现游戏循环)
	- [3.2在线词典介绍](#32在线词典介绍)
	- [3.2.1在线词典-抓包](#321在线词典-抓包)
	- [3.2.2在线词典-代码生成](#322在线词典-代码生成)
	- [3.2.2在线词典-代码生成](#322在线词典-代码生成-1)
	- [3.2.2在线词典-生成代码解读](#322在线词典-生成代码解读)
	- [3.2.3在线词典-生成request body](#323在线词典-生成request-body)
	- [3.2.4在线词典-解析response body](#324在线词典-解析response-body)
	- [3.2.5在线词典-打印结果](#325在线词典-打印结果)
	- [3.2.6在线词典-完善代码](#326在线词典-完善代码)
	- [3.3 SOCKS5代理介绍](#33-socks5代理介绍)
	- [3.3 SOCKS5代理-原理](#33-socks5代理-原理)
	- [3.3.1 SOCKS5代理-TCP echo server](#331-socks5代理-tcp-echo-server)
	- [3.3.2 SOCKS5代理- auth](#332-socks5代理--auth)
	- [3.3.3 SOCKS5代理-请求阶段](#333-socks5代理-请求阶段)
	- [3.3.4 SOCKS5 代理- relay 阶段](#334-socks5-代理--relay-阶段)
	- [3.3.4 SOCKS5 代理- relay 阶段](#334-socks5-代理--relay-阶段-1)
	- [总结](#总结)
