...
---
- [01.基本概念](#01基本概念)
  - [1.1 本地函数调用](#11-本地函数调用)
  - [1.2远程函数调用(RPC - Remote Procedure Calls)](#12远程函数调用rpc---remote-procedure-calls)
      - [函数映射](#函数映射)
  - [1.3 RPC概念模型](#13-rpc概念模型)
  - [1.4 一次RPC的完整过程](#14-一次rpc的完整过程)
  - [1.5 RPC的好处](#15-rpc的好处)
  - [1.6 RPC带来的问题](#16-rpc带来的问题)
- [02 分层设计](#02-分层设计)
  - [2.1分层设计-以Apache Thrift为例](#21分层设计-以apache-thrift为例)
  - [2.2 编解码层-生成代码](#22-编解码层-生成代码)
  - [2.3 编解码层-数据格式](#23-编解码层-数据格式)
  - [2.5 编解码层-二进制编码](#25-编解码层-二进制编码)
  - [2.6 编解码层-选型](#26-编解码层-选型)
  - [2.8 协议层-概念](#28-协议层-概念)
  - [2.9 协议层-协议构造](#29-协议层-协议构造)
  - [2.10 协议层-协议解析](#210-协议层-协议解析)
  - [2.12 网络通信层- Sockets API](#212-网络通信层--sockets-api)
  - [2.13 网络通信层-网络库](#213-网络通信层-网络库)
- [03 关键指标](#03-关键指标)
  - [3.1 稳定性-保障策略](#31-稳定性-保障策略)
  - [3.2 稳定性-请求成功率](#32-稳定性-请求成功率)
  - [3.3 稳定性-长尾请求](#33-稳定性-长尾请求)
  - [3.4 稳定性-注册中间件](#34-稳定性-注册中间件)
  - [3.5 易用性](#35-易用性)
  - [3.6 扩展性](#36-扩展性)
  - [3.7 观测性](#37-观测性)
  - [3.8 高性能](#38-高性能)
- [04 企业实践](#04-企业实践)
  - [4.1整体架构- Kitex](#41整体架构--kitex)
  - [4.2 自研网络库-背景](#42-自研网络库-背景)
  - [4.3 自研网络库- Netpoll](#43-自研网络库--netpoll)
  - [4.4扩展性设计](#44扩展性设计)
  - [4.5 性能优化-网络库优化](#45-性能优化-网络库优化)
  - [4.6 性能优化-编解码优化](#46-性能优化-编解码优化)
  - [4.7 合并部署](#47-合并部署)
  - [课程总结](#课程总结)
